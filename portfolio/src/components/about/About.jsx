        ...
        <div className="about__content">
          <div className="about__cards">
            <article className="about__card">
              ...
              <h5> Experinece </h5>{" "}
              <small> SDE Summer Intern at Barclays India. </small> <br />
          ...
          <p className="para">
            ...
            like coding and problem - solving, I have Solved over 1000 +
            Problems on various platforms like Leetcode and GFG.I am comfortable
            with Full - Stack web development and have worked with libraries and
